...
$data = array(
	...
	'CODES' => array(
        ...
        "INVOICEBOX_RETURN_URL_NOTIFY_2" => array(
			...
			'DEFAULT'     => array(
				'PROVIDER_KEY'   => 'VALUE',
				'PROVIDER_VALUE' => $host . '://' . $request->getHttpHost() . '/bitrix/tools/invoicebox/notification.php',
			),
		),
		...
		'INVOICEBOX_VAT_RATE_BASKET' => array(
            ...
            "INPUT"       => array(
				'TYPE'    => 'ENUM',
                'VALUE' => 'RUS_VAT20',
				'OPTIONS' => array_merge($arTypeNDS, ['SETTINGS_BASKET' => Loc::getMessage('SALE_HPS_INVOICEBOX_RUS_VAT_SETTINGS_BASKET')])
			),
		),
        ...
        'INVOICEBOX_VAT_RATE_DELIVERY' => array(
            ...
            "INPUT"       => array(
				'TYPE'    => 'ENUM',
                'VALUE' => 'RUS_VAT20',
				'OPTIONS' => array_merge($arTypeNDS, ['SETTINGS_DELIVERY' => Loc::getMessage('SALE_HPS_INVOICEBOX_RUS_VAT_SETTINGS_DELIVERY')])
			),
		),
        ...
        "INVOICEBOX_RETURN_URL_NOTIFY_3" => array(
			...
			'DEFAULT'     => array(
				'PROVIDER_KEY'   => 'VALUE',
				'PROVIDER_VALUE' => $host . '://' . $request->getHttpHost() . '/bitrix/tools/invoicebox/notification_v3.php',
			),
		),
        ...
        "INVOICEBOX_RETURN_URL_SUCCESS" => array(
			...
			'DEFAULT'     => array(
				'PROVIDER_KEY'   => 'VALUE',
				'PROVIDER_VALUE' => $host . '://' . $request->getHttpHost() . '/personal/order/payment/invoicebox/success.php',
			),
		),
        "INVOICEBOX_RETURN_URL_CANCEL" => array(
			...
			'DEFAULT'     => array(
				'PROVIDER_KEY'   => 'VALUE',
				'PROVIDER_VALUE' => $host . '://' . $request->getHttpHost() . '/personal/order/payment/invoicebox/failed.php',
			),
		),
	)
); //
